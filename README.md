...
реализован функционал согласно ТЗ: http://localhost/api/docs
* включая выгрузку Списка покупок в PDF
* тестирование выполнено: 
    * локально: без frontend через Postman, db.sqlite3
    * локально: в контейнерах через frontend, Postgres
